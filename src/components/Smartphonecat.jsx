...
function Smartphonecat() {
  ...
  const toggle = () => {
    ...
    const getProducts = () => {
        axios
          ...
          .then((response) => {
            setProducts(response.data.filter(product => product.category === "Smartphones"));
          })
          .catch((error) => {
  ...
  return (
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
      <h2 className=" flex items-center justify-center text-2xl font-bold tracking-tight text-gray-900">Smartphones</h2>

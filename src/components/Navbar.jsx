            ...
            <div className="ml-10 space-x-4">
              ...
              {!isLoggedIn && (
                <>
                  ...
                  <a>
                    <Link to="/signup" className="inline-block bg-white py-2 px-4 border border-transparent rounded-md text-base font-medium text-indigo-600 hover:bg-indigo-50"
                    > Sign Up</Link>

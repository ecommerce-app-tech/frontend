...
function HomePage() {
  ...
  const categories = [
    ...
    },
    {
      ...
      imageSrc:
        "https://img.europapress.es/fotoweb/fotonoticia_20230923105140_640.jpg",
    },
    {
      name: "Earphones",
      href: "products/earphones",
      imageSrc:
        "https://thumb.pccomponentes.com/w-530-530/articles/35/357782/1676-myway-wireless-pro-mwhph0028-auriculares-bluetooth-blancos.jpg",
    },
    {
      name: "Computers",
    ...
    },
    {
      ...
      imageSrc:
        "https://i.blogs.es/27028b/oppo-pad-2-review-xataka-analisis-portada/500_333.jpeg",
    },
  ];
  return (
      ...
      <div className="relative bg-gray-900">
        ...
        <div className="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
          ...
          <p className="mt-4 text-xl text-white">
            ...
            options from our Winter small-batch release while they're still in
            stock.
          </p>
          <Link to={"/products"}>
            <a
